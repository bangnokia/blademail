...
export default function CurrentEmail() {
    ...
    return (
        <div className="relative h-full w-full overflow-auto">
            <div className="toolbox sticky top-0 w-full z-20 flex items-end justify-between bg-white p-2 shadow-sm">
                <button data-tip="Delete this email" onClick={() => deleteEmail(email)} type="button" className="rounded flex items-center bg-white text-gray-500 px-2 py-1 text-xs hover:text-white hover:bg-rose-500  transition">
